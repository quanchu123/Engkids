...
export default function SpaceInvadersPage() {
  ...
  return (
    <>
      <Header />
      <main className="min-h-screen bg-[#000010] flex flex-col items-center pb-8">
        <div className="w-full max-w-xl px-4 pt-4">
          <Link href="/games" className="text-green-400 hover:text-green-300 font-bold text-sm transition-colors">
            ← Quay lại
          </Link>
        </div>

        <div className="text-center my-4">
          <h1 className="text-2xl font-black text-white drop-shadow-lg">👾 Space Invaders</h1>
          <p className="text-green-300 text-sm mt-1">Tiêu diệt tất cả UFO để giành chiến thắng!</p>
        </div>

        <p className="text-green-600/70 text-xs mb-3">← → Di chuyển  |  Space Bắn</p>
        ...
        <p className="text-green-700/50 text-xs mt-4 text-center max-w-xs">
          Clone từ: digitsensitive/phaser3-typescript 🌟  |  Pixel art sprites included
        </p>
      </main>
    </>
  );
