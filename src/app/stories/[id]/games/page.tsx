    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white/90 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link href={`/stories/${id}/vocab`} className="text-gray-500 hover:text-gray-700">
            ← Flashcards
          </Link>
          <h1 className="font-bold text-gray-800">🎮 Mini Games</h1>
          <Link href="/stories" className="text-gray-500 hover:text-gray-700">
            Thư viện
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 text-center mb-8">Chọn game để ôn tập từ vựng!</p>

          <div className="space-y-4">
            {/* Match Game */}
            <button
              onClick={() => setSelectedGame('match')}
              className="w-full p-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl text-white shadow-kid hover:shadow-kid-lg transition-all hover:scale-[1.02]"
            >
              <div className="text-4xl mb-2">🎯</div>
              <h3 className="text-xl font-bold mb-1">Match Game</h3>
              <p className="text-white/80 text-sm">Nối từ tiếng Anh với nghĩa tiếng Việt</p>
            </button>

            {/* Fill Blank Game */}
            <button
              onClick={() => setSelectedGame('fill_blank')}
              className="w-full p-6 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl text-white shadow-kid hover:shadow-kid-lg transition-all hover:scale-[1.02]"
            >
              <div className="text-4xl mb-2">✏️</div>
              <h3 className="text-xl font-bold mb-1">Fill in the Blank</h3>
              <p className="text-white/80 text-sm">Điền từ còn thiếu vào câu</p>
            </button>
          </div>
          ...
          <Link
            href="/stories"
            className="mt-8 w-full py-4 rounded-2xl font-bold bg-white shadow-kid hover:shadow-kid-lg transition-all text-center block text-gray-700"
          >
            📚 Đọc truyện khác
          </Link>
        </div>
    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-white/90 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <h1 className="font-bold text-gray-800">🎯 Match Game</h1>
          <div className="text-green-600 font-bold">{score}/{matchItems.length}</div>
        </div>
      </header>
      ...
      <main className="flex-1 px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              {shuffledEN.map((item: MatchGameItem) => (
                <button
                  ...
                  className={`w-full py-4 px-3 rounded-xl font-medium text-lg transition-all ${
            ...
            {/* Vietnamese meanings */}
            <div className="space-y-3">
              <p className="text-sm font-medium text-gray-500 text-center">Tiếng Việt</p>
    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-white/90 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <h1 className="font-bold text-gray-800">✏️ Fill in the Blank</h1>
          <div className="text-green-600 font-bold">{score}/{questions.length}</div>
        </div>
      </header>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      <div className="text-center max-w-md">
        ...
        {isPerfect && (
          <div className="mb-6">
            <div className="text-4xl star-earned">⭐</div>
            <p className="text-yellow-600 font-medium">+1 Sao!</p>
          </div>
        )}
        ...
        <div className="space-y-3">
          <button
            onClick={onBack}
            className="w-full py-4 rounded-2xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-kid hover:shadow-kid-lg transition-all"
          >
            🎮 Chơi lại
          </button>
          ...
          <Link
            href="/stories"
            className="w-full py-4 rounded-2xl font-bold bg-white shadow-kid hover:shadow-kid-lg transition-all text-gray-700 block"
          >
            📚 Đọc truyện khác
          </Link>
        </div>
