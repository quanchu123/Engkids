...
const CHARACTER_DEFS: Array<[string, string]> = [
  ...
  // Legends, mythology & monsters (round 2)
  ['char-greek-warrior', 'Chiến binh Hy Lạp'],
  ['char-hercules', 'Hercules'],
  ['char-archer', 'Cung thủ'],
  ['char-cowboy', 'Cao bồi'],
  ['char-detective', 'Thám tử'],
  ['char-scientist', 'Nhà khoa học'],
  ['char-scientist-w', 'Nữ khoa học'],
  ['char-policeman', 'Cảnh sát'],
  ['char-chef', 'Đầu bếp'],
  ['char-santa', 'Ông già Noel'],
  ['char-witch-girl', 'Phù thủy nhí'],
  ['char-sage', 'Hiền giả'],
  ['char-buddha', 'Đức Phật'],
  ['char-god', 'Thần linh'],
  ['char-angel', 'Thiên thần'],
  ['char-devil', 'Quỷ vương'],
  ['char-mummy', 'Xác ướp'],
  ['char-frankenstein', 'Quái nhân'],
